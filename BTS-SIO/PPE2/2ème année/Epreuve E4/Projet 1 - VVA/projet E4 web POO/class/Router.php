      ...
      if($page) {
        switch($page) {
          ...
          case 'ajouterAnimation':
            $this->animationController->addAnimation($_POST);
          break;
          case 'modifierAnimation':
            $this->animationController->updateAnimation();
          break;
          case 'ajouterActivite':
            $this->activiteController->addActivite($_POST);
          break;
          case 'annuleActivite':
            $this->activiteController->annuleActivite($this->request->getPost()->get("NOACT"));
          break;
          case 'inscription':
